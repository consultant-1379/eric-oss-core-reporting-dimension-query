...
Contract.make {
    description("""
Represents a successful scenario of getting network slice

given:
  client requests to get network slice
when:
  a valid request is submitted
then:
  request accepted and returns network slice

""")
    request {
        method 'GET'
        urlPath('/oss-core-ws/rest/ctw/networkslice/226') {
            queryParameters {
    ...
    response {
        ...
        body(file("networkslice-NSI-C-226.json"))
    }
}
