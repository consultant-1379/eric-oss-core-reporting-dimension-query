...
Contract.make {
    description("""
Represents a successful scenario of getting network slice subnets

given:
  client requests to send to get network slice subnets
when:
...
""")
    ...
    response {
        ...
        body(file("networkslicesubnet-all.json"))
    }
    priority(70)
}
