...
""")
    request {
        ...
        urlPath('/oss-core-ws/rest/ctw/wirelessnetfunction') {
            queryParameters {
                // The application-id/nodeFDN of WirelessNetworkFunction PCC00012-AMF is PCC00011, inline with sample CTS data provided.
                parameter('ExternalRef::nodeFDN', 'MeContext=PCC00011,ManagedElement=PCC00011')
    ...
    response {
        ...
        body(file("wirelessnetfunction-PCC00012-AMF.json"))
    }
}
