...
given:
  client requests to send to get network slices
when:
  a valid request is submitted
then:
  request accepted and returns network slice list

""")
    request {
        method 'GET'
        urlPath('/oss-core-ws/rest/ctw/networkslice') {
            queryParameters {
    ...
    response {
        ...
        body(file("networkslice-all.json"))
    }
    priority(70)
}
