...
given:
  client requests to get an NRCell
when:
  a valid request is submitted
then:
  request accepted and returns an empty network slice NRCell list
...
""")
    request {
        ...
        urlPath('/oss-core-ws/rest/ctw/nrcell') {
            queryParameters {
                parameter('ExternalRef::nrCellDuFDN', 'SubNetwork=DO5G,MeContext=TD3B297342,ManagedElement=TD3B297342,GNBDUFunction=1,NRCellDU=EMPTY')
            }
        }
        headers {
