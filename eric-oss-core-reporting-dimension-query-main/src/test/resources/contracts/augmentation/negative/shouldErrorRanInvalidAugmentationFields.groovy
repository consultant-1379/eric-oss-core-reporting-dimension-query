        ...
        body("""
                {
                    ...
                    "status": 400,
                    "detail": "Malformed Request, Reason: Invalid augmentationFields value, supported values are: [tac, nsi, nssi, cellId, qos, plmnId, snssai], but found: [${value(consumer(fromRequest().rawBody('\$.augmentationFields[0].name')), producer("invalid"))}]",
                    "instance": null
                }
                """
        )
