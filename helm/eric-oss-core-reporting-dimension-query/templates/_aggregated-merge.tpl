...
*/ -}}
{{- define "eric-oss-core-reporting-dimension-query.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-core-reporting-dimension-query.mergeAnnotations" -}}
  {{- include "eric-oss-core-reporting-dimension-query.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-core-reporting-dimension-query.mergeLabels" -}}
  {{- include "eric-oss-core-reporting-dimension-query.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
